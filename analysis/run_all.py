...
from analysis import national, geographic, cube, lenders, quality, investor
...
def main():
    ...
    print("Running investor analysis...")
    write_json("investor.json", investor.generate(), compact=True)
